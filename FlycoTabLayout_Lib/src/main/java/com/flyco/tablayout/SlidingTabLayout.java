...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    /**
     * 每个tab的内边距，实际上是内部textview的margin。
     */
...
//                tv_tab_title.setPadding((int)mTabPadding,0,(int)mTabPadding,0);
    ...
    public void setTabWidthByPx(float tabWidthByPx) {
        this.mTabWidth = tabWidthByPx;
        updateTabStyles();
    }
...
//            lp.leftMargin = mTabWidth >= 0 ? (int) (mTabWidth / 2 + textWidth / 2 + dp2px(leftPadding)) : (int) (mTabPadding + textWidth + dp2px(leftPadding));
            lp.leftMargin = mTabWidth >= 0 ? (int) (mTabWidth / 2 + textWidth / 2 + dp2px(leftPadding)) : (int) (mTabPadding + textWidth + dp2px(leftPadding));
            Log.e("Kevin", "mTabWidth:" + mTabWidth + " lp.leftMargin:" + lp.leftMargin);
            Log.e("Kevin", "mTabPadding:" + mTabPadding + " textWidth:" + textWidth + " dp2px(leftPadding)" + dp2px(leftPadding));
